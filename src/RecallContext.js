  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      await makeMultipleAPICalls([
        ...
        "https://api.fda.gov/food/enforcement.json?search=report_date:[20220915+TO+20230322]&limit=1000",
        "https://api.fda.gov/food/enforcement.json?search=report_date:[20220220+TO+20220914]&limit=1000",
        "https://api.fda.gov/food/enforcement.json?search=report_date:[20210710+TO+20220219]&limit=1000",
        "https://api.fda.gov/food/enforcement.json?search=report_date:[20200910+TO+20210709]&limit=1000",
        "https://api.fda.gov/food/enforcement.json?search=report_date:[20191231+TO+20200909]&limit=1000",
        "https://api.fda.gov/food/enforcement.json?search=report_date:[20190801+TO+20191230]&limit=1000",
        "https://api.fda.gov/food/enforcement.json?search=report_date:[20190225+TO+20190731]&limit=1000",
        "https://api.fda.gov/food/enforcement.json?search=report_date:[20180810+TO+20190224]&limit=1000",
